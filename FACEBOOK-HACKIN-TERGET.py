...
=================================================
[---]  """+yl+"""Created BY B14CK-KN1GH7(SAJIB CYBER)"""+gr+""" [---]
=================================================
[>] Target      :> """+wi+target+gr+"""
...
Examples:
     ...
     |--------
     | python faceboom.py -t 100044303713323 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python faceboom.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python faceboom.py -t rtsrox10@gmail.com -👉 monirhossain12322bangladesh@gmail.com
     |--------
     | python faceboom.py -g working 8 gb rm
     faceboom.Victim-passRem less on your mobile so Sarver not working
     |--------
""")
def Main():
